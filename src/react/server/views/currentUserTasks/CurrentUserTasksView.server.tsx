        ...
        return (
            <div className="task-board">
                <Island
                    component={TaskBoard}
                    props={{
                        // Same decision as the dashboard route: the query returns page 1 of the
                        // scope the board opens on ("All tasks", see INITIAL_SCOPE), and hands it
                        // straight to the island.
                        initialConnection: result[INITIAL_SCOPE],
